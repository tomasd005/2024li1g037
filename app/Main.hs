...
main = do
  ...
  putStrLn "  - X alterna velocidade 1x/2x/4x"
  putStrLn "  - H e K escondem painel e loja"
  putStrLn "  - ESC abre a pausa durante a partida"
  putStrLn "  - Botao DIREITO para cancelar selecao de torre"
  putStrLn ""
  putStrLn "Como jogar:"
  putStrLn "  1. Clique nas torres na sidebar esquerda para comprar"
